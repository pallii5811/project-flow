...
export function SeriesEnd({
  ...
  return (
    ...
    >
      ...
      <div className={styles.seriesEndScroll}>
        <div className={styles.seriesEndBody}>
          <p className={styles.seriesEndLabel}>
            {complete ? "Series complete" : "More episodes soon"}
          </p>
        ...
        {nextStory ? (
          ...
          >
            <img
              className={styles.nextStoryPoster}
              src={nextStory.posterUrl}
              alt=""
              draggable={false}
            />
