...
| First-load JavaScript                     | ≤ 150 kB                                                                                         | `next build` output (134 kB on 2026-09-17, captions layer, notices and series end included); the catalog is not in it, it is `catalog/feed.json`, fetched after first play                                |
