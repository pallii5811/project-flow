...
1. Read `docs/vision.md`, `docs/product-principles.md`, `docs/ux-principles.md`, `docs/metrics.md`, `docs/roadmap.md`, `docs/decisions.md`, `docs/business-model.md`, `docs/standard.md`.
